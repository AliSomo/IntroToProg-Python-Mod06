...
# Ali Hajisomo,3-19-2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
         """ adding task and priority to list of row
        :param task: the task that is being added
        :param priority: priority of the task that is being added to list/Table
        :param list_of_rows: the list of tables that was added
        :return: the list of row that was added
        """
         row = {"Task": task.strip(), "Priority": priority.strip()}
         list_of_rows.append(row)
         return list_of_rows, 'Success'
    ...
    def remove_data_from_list(task, list_of_rows):
        """ removing task from the list of row
        :param task: The task that is being removed
        :param list_of_rows: The Table the task is being removed from
        :return: the list of dictionary after removing tasks
        """
    ...
    def write_data_to_file(file_name, list_of_rows):
        """ saving data to file
        :param file_name: the file data is being saved in
        :param list_of_rows: list/Table being saved in file
        :return: nothing
        """
...
class IO:
    ...
    def input_new_task_and_priority():
        """ adds new task and priority
        :return:task and priority 
        """
        task = input("Enter new task:")
        priority = input("Task priority [high/low]:")
        return task, priority

    @staticmethod
    def input_task_to_remove():
        """ gets task that is being removed
...
while(True):
    ...
    if strChoice.strip() == '1':  # Show current task
